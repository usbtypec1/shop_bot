...
from aiogram.types import CallbackQuery, ChatType, Message, Update
...
async def on_start_buy_product_flow(
    ...
    ProductBuyStates.quantity.set()
    await state.update_data(product_id=product_id)
    await callback_query.message.answer('Select number of pieces')
