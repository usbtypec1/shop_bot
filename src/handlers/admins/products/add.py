...
from keyboards.inline.callback_factories import ProductCallbackFactory
from loader import dp
from responses.main_menu import AdminMainMenuResponse
...
@dp.callback_query_handler(
    ...
    IsUserAdmin(),
    state=product_states.AddProduct.waiting_picture,
)
...
async def complete_product_adding(
    ...
    await AdminMainMenuResponse(message)
