...
class ProfileResponse(base.BaseResponse):
    def __init__(self, message: aiogram.types.Message, user_id: int,
                 username: str | None, balance: float,
                 purchases_number: int, orders_amount: float,
                 last_purchases: list[tuple[str, int, float]]):
